(function (root, factory) {
        ...
        'initialize': function () {
            ...
            chrome.runtime.onMessage.addListener(function(message)
            {
                if (bgWindow.pade.activeView && message.markdown)
                {
                    ...
                    bgWindow.closeWebAppsWindow(chrome.extension.getURL("plugins/editor.html"));
                }
            });
            ...
            _converse.api.listen.on('renderToolbar', function(view)
            {
                if (bgWindow && !view.el.querySelector(".plugin-markdown"))
                {
                    ...
                    var markdown = __converse.div.parentNode.getElementById("webmeet-markdown-" + id);
    ...
    var doMarkdown = function(view)
    {
        ...
        var url = chrome.extension.getURL("plugins/editor.html");
