...
(function (root, factory) {
    ...
    converse.plugins.add("pade", {
        ...
        initialize: function () {
            ...
            _converse.on('message', function (data)
            {
                ...
                if (!history && body && chatbox)
                {
                    ...
                    if (bgWindow.pade.minimised)
                    {
                        ...
                        bgWindow.setBadge(bgWindow.pade.messageCount.toString(), '#ff0000');
                    }
            ...
            _converse.api.listen.on('chatBoxClosed', function (chatbox)
            {
                ...
                const activeDiv = __converse.div.parentNode.getElementById("active-conversations");
        ...
        overrides: {
                    ...
                    if (messageDiv)
                    {
                        ...
                        if (blockQuote && msgAttachId)
                        {
                            ...
                            blockQuote.addEventListener('click', function(evt)
                            {
                                ...
                                var elmnt = __converse.div.parentNode.getElementById("msg-" + evt.target.getAttribute('msgid'));
            ...
            ChatBoxView: {
                ...
                afterShown: function() {
                    ...
                    var openButton = __converse.div.parentNode.getElementById("pade-active-" + id);
                    var openBadge = __converse.div.parentNode.getElementById("pade-badge-" + id);
    ...
    var displayReactions = function(msgId, positives, negatives)
    {
        ...
        const msgDiv = __converse.div.parentNode.querySelector("#msg-" + msgId + " .chat-msg__text");

        if (msgDiv)
        {
           let reactionDiv = __converse.div.parentNode.querySelector("#msg-" + msgId + " .chat-msg__reactions");
