...
(function(click2vox) {
  ...
  var renderWidget = (function() {
    ...
    handleEvent('click', '.vox-widget-wrapper #send-rating', function(e) {
      ...
      var rate = __converse.div.querySelector('.vox-widget-wrapper input[name=vxb-rate]:checked');
      if (!rate) return;

      var comment = __converse.div.querySelector('.vox-widget-wrapper #rating-message');
    ...
    var starRatingButtons = __converse.div.querySelectorAll(".vox-widget-wrapper input[name=vxb-rate]");
    Array.prototype.forEach.call(starRatingButtons, function(el, i) {
      el.addEventListener('click', function(e) {
        var element = __converse.div.querySelector(".vox-widget-wrapper #send-rating");
    ...
    var padButtons = __converse.div.querySelectorAll(".vox-widget-wrapper .vw-dialpad li");
    ...
    handleEvent('click', '.vox-widget-wrapper #full-screen i', function(e) {
      ...
      __converse.div.querySelector(widget_body_selector).classList.toggle('hidden');

      var widget_mic_header_selector = ".vox-widget-wrapper .vw-header";

      if (__converse.div.querySelector(widget_body_selector + " #vw-in-call").classList.contains('hidden'))
        __converse.div.querySelector(widget_mic_header_selector).classList.remove('minimized');
      else
        __converse.div.querySelector(widget_mic_header_selector).classList.toggle('minimized');
    ...
    handleEvent('click', '.vox-widget-wrapper i.vx-icon-pad', function(e) {
      e.preventDefault();
      var element = __converse.div.querySelector(".vox-widget-wrapper .vw-dialpad");
    ...
    var draggableWidget = function(Draggabilly) {
      ...
      draggable.on('dragEnd', function() {
        ...
        if (!__converse.div.querySelector('.vox-widget-wrapper[class*="vw-top"]') && !draggableFixed) {
          var screen_h = window.innerHeight;
          var widget = __converse.div.querySelector(".vox-widget-wrapper .vw-main");
  ...
  openPopup = function() {
    ...
    var buttonData = __converse.div.querySelector('.voxButton').dataset;
  ...
  function handleEvent(eventName, selector, callback) {
    var elements = __converse.div.querySelectorAll(selector);
  ...
  function setWidgetTitle(title) {
    var el = __converse.div.querySelector('.vox-widget-wrapper #vw-title');
  ...
  function makeCall() {
    ...
    if (isWebRTCSupported() && !isChromeOnHttp()) {
      ...
      if (isPopUp()) {
        var dialPad = __converse.div.querySelector(".vox-widget-wrapper .vw-dialpad");
        dialPad.classList.toggle('active');
        var wrapper = __converse.div.querySelector(".vox-widget-wrapper .vw-main");
        wrapper.style.margin = 0;
        var header = __converse.div.querySelector(".vox-widget-wrapper .vw-main .vw-header");
  ...
  function resetWidget() {
    ...
    //Widget placement
    var vox_widget_wrapper = __converse.div.querySelector('.vox-widget-wrapper');
    ...
    __converse.div.querySelector(".vox-widget-wrapper").style.display = "block";
    ...
    // Reset Rating
    __converse.div.querySelector('.vox-widget-wrapper #send-rating').classList.add("vxb-btn-style-disabled");
    __converse.div.querySelector('.vox-widget-wrapper #rating-message').value = "";

    var full_screen_icon = __converse.div.querySelector('.vox-widget-wrapper #full-screen i');
  ...
  function setMicDots(className) {
    var micDots = __converse.div.querySelectorAll('.vox-widget-wrapper .vox-mic-vumeter em');
  ...
  function setMicDot(dot) {
    ...
    var dots = __converse.div.querySelectorAll('.vox-widget-wrapper #mic' + dot);
  ...
  function showElement(selector) {
    var el = __converse.div.querySelector(selector);
    if (el)
  ...
  function showAnimatedDots() {
    var dots = __converse.div.querySelectorAll('.vox-widget-wrapper .vw-animated-dots');
    Array.prototype.forEach.call(dots, function(el, i) {
      el.classList.remove('hidden');
    });
  }
  ...
  function getRingbackTone() {
    return __converse.div.querySelector('.voxButton #audio-ringback-tone');
  }
