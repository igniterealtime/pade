        ...
        'initialize': function () {
            ...
            SearchDialog = _converse.BootstrapModal.extend({
                ...
                doSearch() {
                    ...
                    if (keyword != "")
                    {
                        ...
                        for (var i=0; i<messages.length; i++)
                        {
                            var button = __converse.div.parentNode.getElementById("search-" + messages[i].get('msgid'));
            ...
            _converse.api.listen.on('renderToolbar', function(view)
            {
                if (!view.el.querySelector(".plugin-search"))
                {
                    ...
                    var search = __converse.div.parentNode.getElementById("pade-search-" + id);
                    ...
                    if (view)
                    {
                        this.el.querySelectorAll('.badge-hash-tag').forEach(function(hashtag)
                        {
                            ...
                            hashtag.addEventListener('click', function(evt)
                            {
                                ...
                                const tag = __converse.div.parentNode.getElementById("msg-" + evt.target.getAttribute("data-hashtag"));
