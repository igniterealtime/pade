...
window.addEventListener("load", function() 
{
    ...
    function doIt() {
        ctxSip = {
            ...
            newSession: function(newSess) {
                ...
                if (newSess.direction === 'incoming') {
                    ...
                    //bgWindow.etherlynk.drawAttentionPhone();
                } else {
            ...
            logCall: function(session, status) {
                ...
                var log = {
                    ...
                    calllog = JSON.parse(ctxSip.localStorage.getItem('sipCalls'));
                ...
                ctxSip.localStorage.setItem('sipCalls', JSON.stringify(calllog));
                ctxSip.logShow();
            },
            ...
            logShow: function() {
                ...
                var calllog = JSON.parse(ctxSip.localStorage.getItem('sipCalls')),
                    x = [];
            ...
            logClear: function() {
                ...
                ctxSip.localStorage.removeItem('sipCalls');
                ctxSip.logShow();
            },
        ...
        var closePhone = function() {
            ...
            ctxSip.phone.off('connected', onConnected);
            ctxSip.phone.off('disconnected', onDisconnected);
            ctxSip.phone.off('registered', onRegistered);
            ctxSip.phone.off('registrationFailed', onRegistrationFailed);
            ctxSip.phone.off('unregistered', onUnregistered);
            ctxSip.phone.off('invite', onInvite);
            ctxSip.phone.off('uiinvite', onInvite);
        };
        ...
        $('#sip-logitems').delegate('.sip-logitem .btnCall', 'click', function(event) {
            sessionid = $(this).closest('.sip-logitem').data('sessionid');
